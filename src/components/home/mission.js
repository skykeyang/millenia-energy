...
export default function Mission() {
    ...
    return (
        <div className="container section-two-container" ref={ref}>
        ...
        <section id='mission' className="missionvision" 
            style={{transform: isInView ? "none" : "translateY(200px)",
            opacity: isInView ? 1 : 0,
            transition: "all 0.9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s"}}>
                ...
                <p className="visioncontent">
                At Millenia Energy, we assume roles as project developer, owner, and operator for solar ventures, alleviating capital cost constraints for our clients. 
                Your seamless and cost-effective solar journey is our priority.
                </p>
