    ...
    return (
        <div>
            ...
            <div className="project-main-image d-flex justify-content-center">
                <img src={require("../../images/portfolio/PF5IMG1.jpg").default} alt="article3"/>
            </div>
            ...
            <table className="project-secondary-images justify-content-center">
                <tr>
                    <td>
                    <img src={require("../../images/portfolio/PF5IMG2.jpg").default} alt="image" className="project-secondary-image"/>
                    </td>
                    <td>
                    <img src={require("../../images/portfolio/PF5IMG3.jpg").default} alt="image" className="project-secondary-image"/>
                    </td>
                </tr>
            </table>
            </div>
